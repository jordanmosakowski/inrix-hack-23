...
const JetStreamMap = forwardRef(function JetStreamMap( { origin, des, start, end, route1LineStr, route2LineStr}, ref ) {
  ...
  return (
    <div className="JetStreamMap">
      <DeckGL
        ...
        controller={true}
        layers={(route1LineStr && route2LineStr) ? [...layers, 
          new GeoJsonLayer({
            id: "driving",
            data: route1LineStr,
            stroked: false,
